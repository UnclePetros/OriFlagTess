...
Download the latest version (current is v0.2-alpha): [https://github.com/UnclePetros/OriFlagTess/releases/tag/v0.3](https://github.com/UnclePetros/OriFlagTess/releases/tag/v0.3)  
